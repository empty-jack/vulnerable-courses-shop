...
<html lang="en">
    ...
    <link rel="icon" href="https://d3njjcbhbojbot.cloudfront.net/web/images/favicons/apple-touch-icon-57x57.png">
    <title>Pricing</title>
    <!-- Bootstrap core CSS -->
...
<body>
    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
        ...
        <p class="lead">Specializations and courses in software development address the process of creating software, including development tools and methodologies (such as Agile development), programming languages (including Python, C, Java, and Scala), and software architecture and testing.</p>
    </div>
    <div class="container">
        <div class="card-deck mb-3 text-center">
            <div class="card mb-4 box-shadow">
                <div class="card-header">
                    <h4 class="my-0 font-weight-normal">Beginer</h4>
                </div>
                <div class="card-body">
                    ...
                    <button type="button" data-toggle="modal" data-target="#exampleModal" class="btn btn-lg btn-block btn-outline-primary">Buy this course</button>
                </div>
            </div>
            <div class="card mb-4 box-shadow">
                <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    <button type="button" data-toggle="modal" data-target="#exampleModal" class="btn btn-lg btn-block btn-primary">Buy this course</button>
                </div>
            </div>
            <div class="card mb-4 box-shadow">
                <div class="card-header">
        ...
        <script type="text/javascript">
            $(".card-body .btn").click(function(){
                $("#product-id").val($(this).parent().parent().find(".my-0").text());
                $("#price").val($(this).parent().find(".pricing-card-title").text().replace(/[\$\s\/a-zA-Z]/gi,""));
            });
        </script>
        <!-- Modal -->
                ...
                <div class="modal-content">
                    <form action="/order.php" method="POST" class="form-group">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Do you want buy the cource?</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <p>
                                ...
                                <input class="form-control" type="text" id="name" name="name" required placeholder="John Doe"/>
                            </p>
                            <p>
                                <label for="email">E-mail: </label>
                                <input class="form-control" type="email" id="email" name="email" required placeholder="john@example.com"/>
                            </p>
                            <p>
                                <label for="phone">Phone number: </label>
                                <input class="form-control" type="phone" id="phone" name="phone" required placeholder="+79876543210"/>
                            </p>
                            <p>
                                <label for="comment">Comments: </label>
                                <textarea class="form-control" id="comment" name="comment" placeholder="Any question or comments on your order?" required rows="3"></textarea>
                            </p>
                            <input type="text" id="product-id" name="productID" value="" hidden >
                            <input type="text" id="price" name="price" value="10" hidden >
        ...
        <footer class="pt-4 my-md-5 pt-md-5 border-top">
            <div class="row">
                <div class="col-12 col-md">
                    <img class="mb-2" src="https://d3njjcbhbojbot.cloudfront.net/web/images/favicons/apple-touch-icon-57x57.png" alt="" width="24" height="24">
